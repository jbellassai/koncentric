...
private object UserNameUpdatedListener : IDomainPersistenceEventListener<UserNameUpdated, DatabaseType> {
...
private object GroupMembershipAddedListener : IDomainPersistenceEventListener<GroupMembershipAdded, DatabaseType> {
...
class R2dbcPostgresUserAndGroupTest : PersistenceTests(
    txManager,
    UserRepository,
    GroupRepository,
